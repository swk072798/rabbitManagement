...
public interface MaterialsRecordService {
    ...
    ResponseMessage<PageInfo<RabbitMaterialsRecord>> getMaterialsRecordByCondition(String dbName, String username, Integer limit, Integer page, String condition, String value);
}
